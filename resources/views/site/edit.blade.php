...
@section('page_content')
    ...
    <div class="container post-page">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal site-form" name="form-{{ $page }}" id="form-{{ $page }}" action="{{ url($action) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
...
@endif
                        ...
                        <button class="btn btn-success save" type="button"><i class="fa fa-save"></i> @lang($page . '.Save')</button>
    ...
    @else
        <div class="alert alert-danger m-t-150">
            <span>@lang('site.You do not have permission to view this page')</span>
        </div>
    @endif
@endsection
