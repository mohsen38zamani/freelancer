...
@section('panelContent')
    ...
    @if($permission && $permission[$page_action])
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" name="form-{{ $page }}" id="form-{{ $page }}" action="{{ url($action) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    @endif
                    @php unset($block_field['information']['roleid']['option'][1]); @endphp
