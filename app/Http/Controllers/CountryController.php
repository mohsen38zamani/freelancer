...
class CountryController extends GamaController
{
    /**
    ...
    public function __construct()
    {
        ...
        /* module details */
        $this->module['modulename'] = 'country';
        ...
        $this->module['moduleparent'] = array('mainland' => array('name'), 'currency' => array('name'));//array('module name' => array('module show fields'))
        $this->module['moduleshowparentview'] = array('mainland', 'currency');// select parent for show in edit view
