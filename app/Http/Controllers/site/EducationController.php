...
class EducationController extends GamaSiteController
{
    /**
    ...
    public function __construct()
    {
        ...
        /* module details */
        $this->module['modulename'] = 'education';
        ...
        $this->module['moduleshowparentview'] = array('country');// select parent for show in edit view
