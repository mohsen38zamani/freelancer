...
class MainlandController extends GamaController
{
    /**
    ...
    public function __construct()
    {
        ...
        /* module details */
        $this->module['modulename'] = 'mainland';
        ...
        $this->module['modulechild'] = array('country' => array('name')); //array('module name' => array('module show fields'))
