...
class FootermenuController extends GamaController
{
    /**
    ...
    public function __construct()
    {
        ...
        /* module details */
        $this->module['modulename'] = 'footermenu';
        ...
        $this->module['modulechild'] = array('footeritem' => array('name')); //array('module name' => array('module show fields'))
