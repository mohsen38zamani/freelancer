...
class FooteritemController extends GamaController
{
    /**
    ...
    public function __construct()
    {
        ...
        /* module details */
        $this->module['modulename'] = 'footeritem';
        ...
        $this->module['moduleparent'] = array('footermenu' => array('name'));//array('module name' => array('module show fields'))
        $this->module['moduleshowparentview'] = array('footermenu');// select parent for show in edit view
