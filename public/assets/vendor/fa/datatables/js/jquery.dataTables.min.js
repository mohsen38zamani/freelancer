...
(function (h) {
    ...
    function Da(a) {
        ...
        !a.sEmptyTable && (c && "هیچ اطلاعاتی برای نمایش وجود ندارد" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function pb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + ' col-xs-12"/>', j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "اول", sLast: "آخر", sNext: "بعدی", sPrevious: "قبلی"},
            sEmptyTable: "هیچ اطلاعاتی برای نمایش وجود ندارد",
            sInfo: "نمایش _START_ تا _END_ از _TOTAL_ سطر موجود",
            sInfoEmpty: "نمایش 0 تا 0 از 0 سطر موجود",
            sInfoFiltered: "(جستجو از _MAX_ سطر موجود)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "",
